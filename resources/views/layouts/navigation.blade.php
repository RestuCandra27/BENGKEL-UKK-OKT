        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        {{-- Override Background Dropdown --}}
                        <div class="bg-gray-800 border-gray-700 text-gray-200">
                             <x-dropdown-link :href="route('profile.edit')" class="hover:bg-gray-700 text-gray-200">
                                {{ __('Profil Saya') }}
                            </x-dropdown-link>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')"
                                        class="hover:bg-gray-700 text-red-400 hover:text-red-300"
